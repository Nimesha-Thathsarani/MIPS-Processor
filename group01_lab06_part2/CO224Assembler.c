...
int main( int argc, char *argv[] )
{
	...
	*************************************************************************/
	...
	char *op_sra 	= "00001001";
	char *op_sla 	= "00001010";
	char *op_srl 	= "00001011";
	char *op_sll 	= "00001100";
	char *op_ror 	= "00001101";
	char *op_rol 	= "00001110";
	char  op_mult 	= "00001111";
	char *op_lwd 	= "00010000";
	char *op_lwi 	= "00010001";
	char *op_swd 	= "00010010";
	char *op_swi 	= "00010011";
	/************************************************************************/
 	...
 	while(fgets(line, LINE_SIZE, fi)!=NULL) // Read a line from the input .s file
	{
		...
		*******************************************************************/
		...
		while(in_token!=NULL)
		{
			...
			else if(strcasecmp(in_token,"rol")==0) strcpy(out_token, op_rol);
